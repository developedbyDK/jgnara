...
const MOCK_DATA: RecruitPost[] = [
  {
    id: 25,
    title: "25톤 크레인 운전기사 모집 (경력 5년 이상)",
    company: "대한건설",
    region: "서울",
    salary: "월 400만원~",
    category: "운전기사",
