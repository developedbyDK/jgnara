...
// ─── History Data ────────────────────────────────────
const HISTORY = [
  { year: "2024", events: ["건설장비 종합 플랫폼 '중기나라' 리뉴얼 오픈", "월간 방문자 50만 돌파", "모바일 앱 출시"] },
  { year: "2022", events: ["구인구직 서비스 오픈", "자유게시판 / 주요양식 서비스 추가"] },
  { year: "2020", events: ["업체찾기/등록 서비스 런칭", "누적 매물 등록 10,000건 돌파"] },
  { year: "2018", events: ["VIP 프리미엄 매물 서비스 도입", "전국 업체 네트워크 구축"] },
  { year: "2015", events: ["중기나라 온라인 서비스 오픈", "건설기계 매매 중개 서비스 시작"] },
...
const SERVICES = [
  {
    ...
    title: "중장비 매매",
    description: "굴착기, 덤프트럭, 크레인 등 전 기종 매매 중개. VIP 프리미엄 서비스로 빠른 거래를 지원합니다.",
  },
  {
    icon: <IconBuildingSkyscraper className="h-8 w-8" />,
    title: "업체찾기/등록",
    description: "전국 건설장비 매매/정비/임대 업체를 한눈에 찾고, 내 업체를 등록하여 홍보할 수 있습니다.",
  },
  {
    icon: <IconUsers className="h-8 w-8" />,
    title: "구인/구직",
    description: "건설장비 운전기사, 정비사, 현장관리 등 전문 인력 채용과 구직 서비스를 제공합니다.",
  },
  {
    icon: <IconShieldCheck className="h-8 w-8" />,
    title: "안전한 거래",
    description: "허위 매물 방지 시스템과 신뢰도 검증을 통해 안전하고 투명한 거래 환경을 보장합니다.",
  },
  {
    icon: <IconHeadset className="h-8 w-8" />,
    title: "전문 상담",
    description: "건설장비 전문 상담사가 매매부터 등록, 보험, 검사까지 원스톱으로 안내해드립니다.",
  },
  {
    icon: <IconTargetArrow className="h-8 w-8" />,
    title: "주요양식 제공",
    description: "매매계약서, 양도증명서, 등록신청서 등 건설장비 거래에 필요한 모든 양식을 제공합니다.",
  },
];
    ...
    <div className="space-y-10">
      ...
      <section>
        ...
        <p className="mt-4 leading-relaxed text-neutral-600 dark:text-neutral-400">
          중기나라는 2010년 설립 이후, 건설장비 매매를 중심으로 업체찾기, 구인구직,
          주요양식 제공 등 건설장비에 관한 모든 서비스를 한 곳에서 제공하고 있습니다.
          전국의 건설장비 종사자분들이 편리하고 안전하게 이용할 수 있는
          신뢰받는 플랫폼이 되겠습니다.
        </p>
      </section>
      ...
      <section className="border border-neutral-200 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-800/50">
        ...
        <div className="divide-y divide-neutral-200 dark:divide-neutral-700">
          ...
          <InfoRow
            ...
            label="주소"
            value="경기도 화성시 동탄대로 123, 한서빌딩 5층"
          />
          <InfoRow
