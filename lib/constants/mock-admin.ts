...
export const RECENT_ACTIVITIES: RecentActivity[] = [
  ...
  },
  {
    id: "2",
    type: "매물등록",
    message: "현대 220LC-9S 굴삭기 매물이 등록되었습니다",
    time: "12분 전",
    user: "이영희",
  },
  {
  ...
  },
  {
    id: "4",
    type: "업체등록",
    message: "(주)한국중장비가 업체 등록을 신청했습니다",
    time: "35분 전",
    user: "최동현",
  },
  {
    id: "5",
    type: "신고",
    message: "매물 #3421에 대한 신고가 접수되었습니다",
    time: "1시간 전",
    user: "정수진",
  },
  {
  ...
  },
  {
    id: "7",
    type: "매물등록",
    message: "두산 DX225LCA 매물이 등록되었습니다",
    time: "2시간 전",
    user: "윤성호",
  },
  {
...
export const MOCK_COMPANIES: AdminCompany[] = [
  {
    ...
    representative: "이영희",
    phone: "031-123-4567",
    email: "info@yhce.co.kr",
    businessNumber: "123-45-67890",
    address: "서울특별시 강남구 테헤란로70길 12",
    status: "승인",
    registeredAt: "2024-02-20",
    listingCount: 15,
    type: "매매/렌탈",
  },
  {
    ...
    representative: "최동현",
    phone: "02-456-7890",
    email: "contact@khce.co.kr",
    businessNumber: "234-56-78901",
    address: "서울 강서구 마곡중앙로 45",
    status: "정지",
    registeredAt: "2024-03-10",
    listingCount: 8,
    type: "매매",
  },
  {
    ...
    representative: "박민수",
    phone: "063-789-0123",
    email: "mscc@naver.com",
    businessNumber: "345-67-89012",
    address: "전북 전주시 덕진구 만성로 67",
    status: "승인",
    registeredAt: "2023-11-05",
    listingCount: 42,
    type: "매매/정비",
  },
  {
    ...
    representative: "윤성호",
    phone: "055-012-3456",
    email: "shmc@gmail.com",
    businessNumber: "456-78-90123",
    address: "경남 창원시 의창구 창이대로 89",
    status: "승인",
    registeredAt: "2023-09-12",
    listingCount: 67,
    type: "매매/렌탈/정비",
  },
  {
    ...
    representative: "송미경",
    phone: "031-345-6789",
    email: "mkce@email.com",
    businessNumber: "567-89-01234",
    address: "경기도 안산시 상록구 해안로 111",
    status: "승인",
    registeredAt: "2024-06-18",
    listingCount: 22,
    type: "매매",
  },
  {
    ...
    representative: "오재현",
    phone: "041-678-9012",
    email: "jhce@email.com",
    businessNumber: "678-90-12345",
    address: "충남 천안시 서북구 두정로 33",
    status: "승인",
    registeredAt: "2024-04-12",
    listingCount: 31,
    type: "렌탈",
  },
  {
    ...
    representative: "장대한",
    phone: "032-901-2345",
    email: "dhce@email.com",
    businessNumber: "789-01-23456",
    address: "인천 남동구 남동대로 55",
    status: "심사중",
  ...
  },
  {
    ...
    representative: "김서울",
    phone: "02-234-5678",
    email: "seoulce@email.com",
    businessNumber: "890-12-34567",
    address: "서울 금천구 가산디지털로 77",
    status: "반려",
...
export const MOCK_BANNERS: AdminBanner[] = [
  ...
  },
  {
    id: "B002",
    title: "VIP 회원 혜택 안내",
    imageUrl: "/images/banner-vip.jpg",
    linkUrl: "/vip",
    position: "메인",
    status: "활성",
  ...
  },
  {
    id: "B003",
    title: "성호기계 VIP 광고",
    imageUrl: "/images/banner-sh.jpg",
    linkUrl: "/companies/C004",
    position: "VIP",
    status: "활성",
    startDate: "2025-01-01",
    endDate: "2025-06-30",
  ...
  },
  {
    id: "B004",
    title: "영희중장비 VIP 광고",
    imageUrl: "/images/banner-yh.jpg",
    linkUrl: "/companies/C001",
    position: "VIP",
    status: "활성",
    startDate: "2025-01-01",
    endDate: "2025-06-30",
  ...
  },
  {
    id: "B005",
    title: "건설기계 자격증 안내",
    imageUrl: "/images/banner-license.jpg",
    linkUrl: "/board/license-info",
    position: "사이드",
    status: "활성",
    startDate: "2025-01-01",
    endDate: "2025-12-31",
  ...
  },
  {
    id: "B006",
    title: "봄맞이 특가전 예정",
    imageUrl: "/images/banner-spring.jpg",
    linkUrl: "/event/spring",
    position: "메인",
    status: "예약",
  ...
  },
  {
    id: "B007",
    title: "앱 다운로드 배너",
    imageUrl: "/images/banner-app.jpg",
